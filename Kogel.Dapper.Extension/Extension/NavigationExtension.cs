...
namespace Kogel.Dapper.Extension.Extension
{
    ...
    public static class NavigationExtension
    {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static async Task<GridReader> QueryMultiplesAsync<T>(this IDbConnection dbCon, SqlProvider provider, IDbTransaction transaction)
        {
            return await dbCon.QueryMultipleAsync(provider.SqlString, provider.Params, transaction);
        }
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static async Task<T> QuerySingleAsyncs<T>(this IDbConnection dbCon, SqlProvider provider, IDbTransaction transaction)
        {
